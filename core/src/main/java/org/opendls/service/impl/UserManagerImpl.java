...
import org.opendls.dao.UserDao;
import org.opendls.model.User;
import org.opendls.service.UserExistsException;
import org.opendls.service.UserManager;
import org.opendls.service.UserService;
 ...
 */
@WebService(serviceName = "UserService", endpointInterface = "org.opendls.service.UserService")
