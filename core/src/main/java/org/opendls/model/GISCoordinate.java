...
public class GISCoordinate
{
    ...
    /*
     * in degrees minutes format lat DCFormat - DD.DD, DD:MM.MM or DD:MM:SS.SS lon
     * DCFormat - DD.DD, DD:MM.MM or DD:MM:SS.SS latDir - N/S lonDir - W/E
     */
    ...
    public void move(double distft, double direction, int model)
            throws Exception
    {
        double distNM = distft / (185200.0 / 30.48); // convert to nm (does
                                                        // that stand for
                                                        // nautical miles??)
            ...
            double distNM) throws Exception
    {
        ...
        {
            dlon = Math.atan2(Math.sin(dirRad) * Math.sin(distNM)
                    * Math.cos(latRad), Math.cos(distNM) - Math.sin(latRad)
                    * Math.sin(lat));
