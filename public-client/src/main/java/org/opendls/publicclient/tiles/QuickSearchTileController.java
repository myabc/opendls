...
/**
 * <code>ViewPreparer</code> for the quick search block tile, that includes
 * a list of all visible collections within the System.
 *
 * @author alexbcoles
 *
 */
public class QuickSearchTileController extends ViewPreparerSupport
{
